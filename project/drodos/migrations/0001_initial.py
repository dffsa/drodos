# Generated by Django 3.0.4 on 2020-03-29 17:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('toGroup', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='drodos.Group')),
            ],
        ),
        migrations.AddField(
            model_name='group',
            name='item',
            field=models.ManyToManyField(related_name='item', to='drodos.StoredItem'),
        ),
        migrations.AddField(
            model_name='group',
            name='member',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('StoredItem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='drodos.StoredItem')),
            ],
        ),
    ]
